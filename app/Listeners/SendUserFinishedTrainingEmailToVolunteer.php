...
use App\Mail\UserFinishedTrainingEmail;
...
class SendUserFinishedTrainingEmailToVolunteer
{
    /**
    ...
    public function handle(UserFinishedTraining $event)
    {
        ...
        EmailJob::dispatch($user,new UserFinishedTrainingEmail($user,$training));
    }
}
